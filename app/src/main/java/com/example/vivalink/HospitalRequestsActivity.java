...
public class HospitalRequestsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // الوصول لعقدة Requests (تأكد من الحرف الكبير R)
        ...
        btnAdd.setOnClickListener(v -> startActivity(new Intent(this, CreateRequestActivity.class)));
    }

    private void loadRequests() {
        // الفلترة باستخدام hospitalId الموجود في الرولز عندك
        db.orderByChild("hospitalId").equalTo(hospitalId).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(HospitalRequestsActivity.this, "خطأ في التحميل", Toast.LENGTH_SHORT).show();
            }
        });
    }
}